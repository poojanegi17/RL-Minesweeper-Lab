...
import { ArrowRight, Coins, Eye, GitBranch } from "lucide-react";
 ...
 * room for both.
 *
 * Recovered from the previous home page. The trailing `AlgorithmPipeline`
 * it carried there is dropped here: the About hero already renders that exact
 * loop, and showing it twice on one page reads as a mistake rather than as
 * emphasis. Everything else is the original component.
 */
