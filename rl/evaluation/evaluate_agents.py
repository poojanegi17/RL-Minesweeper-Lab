"""Compare RandomAgent, CSPAgent, QLearningAgent, and DQNAgent on the same Minesweeper configuration.
...
def main() -> None:
    """Evaluate RandomAgent, CSPAgent, QLearningAgent, and DQNAgent on identical board configurations and print a report."""
